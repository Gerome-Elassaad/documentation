import process from 'node:process';globalThis._importMeta_={url:import.meta.url,env:process.env};import { getRequestHeader, splitCookiesString, setResponseStatus, setResponseHeader, send, getRequestHeaders, defineEventHandler, handleCacheHeaders, createEvent, fetchWithEvent, isEvent, eventHandler, getResponseStatus, setResponseHeaders, setHeaders, sendRedirect, proxyRequest, createError, getRequestHost, getRequestProtocol, getQuery as getQuery$1, getRequestURL, setHeader, getCookie, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getRouterParam, readBody, getResponseStatusText, H3Error } from 'file:///home/Gerome-Elassaad/documentation/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { mkdirSync } from 'node:fs';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { parentPort, threadId } from 'node:worker_threads';
import _RemarkEmoji from 'file:///home/Gerome-Elassaad/documentation/node_modules/remark-emoji/index.js';
import { visit } from 'file:///home/Gerome-Elassaad/documentation/node_modules/unist-util-visit/index.js';
import { toString } from 'file:///home/Gerome-Elassaad/documentation/node_modules/hast-util-to-string/index.js';
import defu, { defuFn, defu as defu$1 } from 'file:///home/Gerome-Elassaad/documentation/node_modules/defu/dist/defu.mjs';
import { html as html$2 } from 'file:///home/Gerome-Elassaad/documentation/node_modules/satori-html/dist/index.js';
import { withQuery, joinURL, withTrailingSlash, parseURL, withoutBase, getQuery, joinRelativeURL, hasProtocol, withHttps, withoutProtocol, withoutTrailingSlash, withoutLeadingSlash, withLeadingSlash, isRelative, withBase } from 'file:///home/Gerome-Elassaad/documentation/node_modules/ufo/dist/index.mjs';
import sizeOf from 'file:///home/Gerome-Elassaad/documentation/node_modules/image-size/dist/index.js';
import { createGenerator } from 'file:///home/Gerome-Elassaad/documentation/node_modules/@unocss/core/dist/index.mjs';
import presetWind from 'file:///home/Gerome-Elassaad/documentation/node_modules/@unocss/preset-wind/dist/index.mjs';
import { consola, createConsola } from 'file:///home/Gerome-Elassaad/documentation/node_modules/consola/dist/index.mjs';
import { Launcher } from 'file:///home/Gerome-Elassaad/documentation/node_modules/chrome-launcher/dist/index.js';
import playwrightCore from 'file:///home/Gerome-Elassaad/documentation/node_modules/playwright-core/index.mjs';
import { createWasmOnigEngine } from 'file:///home/Gerome-Elassaad/documentation/node_modules/shiki/dist/engine-oniguruma.mjs';
import { createStorage, prefixStorage, normalizeKey } from 'file:///home/Gerome-Elassaad/documentation/node_modules/unstorage/dist/index.mjs';
import { hash } from 'file:///home/Gerome-Elassaad/documentation/node_modules/ohash/dist/index.mjs';
import { basename, isAbsolute, extname } from 'file:///home/Gerome-Elassaad/documentation/node_modules/pathe/dist/index.mjs';
import { snakeCase, kebabCase, pascalCase, camelCase } from 'file:///home/Gerome-Elassaad/documentation/node_modules/scule/dist/index.mjs';
import { unified } from 'file:///home/Gerome-Elassaad/documentation/node_modules/unified/index.js';
import { toString as toString$1 } from 'file:///home/Gerome-Elassaad/documentation/node_modules/mdast-util-to-string/index.js';
import { postprocess, preprocess } from 'file:///home/Gerome-Elassaad/documentation/node_modules/micromark/dev/index.js';
import { stringifyPosition } from 'file:///home/Gerome-Elassaad/documentation/node_modules/unist-util-stringify-position/index.js';
import { markdownLineEnding, markdownSpace } from 'file:///home/Gerome-Elassaad/documentation/node_modules/micromark-util-character/dev/index.js';
import { push, splice } from 'file:///home/Gerome-Elassaad/documentation/node_modules/micromark-util-chunked/dev/index.js';
import { resolveAll } from 'file:///home/Gerome-Elassaad/documentation/node_modules/micromark-util-resolve-all/index.js';
import { normalizeUri } from 'file:///home/Gerome-Elassaad/documentation/node_modules/micromark-util-sanitize-uri/dev/index.js';
import slugify from 'file:///home/Gerome-Elassaad/documentation/node_modules/slugify/slugify.js';
import remarkParse from 'file:///home/Gerome-Elassaad/documentation/node_modules/remark-parse/index.js';
import remark2rehype from 'file:///home/Gerome-Elassaad/documentation/node_modules/remark-rehype/index.js';
import remarkMDC, { parseFrontMatter } from 'file:///home/Gerome-Elassaad/documentation/node_modules/remark-mdc/dist/index.mjs';
import remarkGFM from 'file:///home/Gerome-Elassaad/documentation/node_modules/remark-gfm/index.js';
import rehypeExternalLinks from 'file:///home/Gerome-Elassaad/documentation/node_modules/rehype-external-links/index.js';
import rehypeSortAttributeValues from 'file:///home/Gerome-Elassaad/documentation/node_modules/rehype-sort-attribute-values/index.js';
import rehypeSortAttributes from 'file:///home/Gerome-Elassaad/documentation/node_modules/rehype-sort-attributes/index.js';
import rehypeRaw from 'file:///home/Gerome-Elassaad/documentation/node_modules/rehype-raw/index.js';
import { detab } from 'file:///home/Gerome-Elassaad/documentation/node_modules/detab/index.js';
import Slugger from 'file:///home/Gerome-Elassaad/documentation/node_modules/github-slugger/index.js';
import destr, { destr as destr$1 } from 'file:///home/Gerome-Elassaad/documentation/node_modules/destr/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///home/Gerome-Elassaad/documentation/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, parse as parse$1, uneval } from 'file:///home/Gerome-Elassaad/documentation/node_modules/devalue/index.js';
import { renderToString } from 'file:///home/Gerome-Elassaad/documentation/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file:///home/Gerome-Elassaad/documentation/node_modules/@unhead/ssr/dist/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin, createHeadCore } from 'file:///home/Gerome-Elassaad/documentation/node_modules/unhead/dist/index.mjs';
import { isVNode, toValue, version, unref } from 'file:///home/Gerome-Elassaad/documentation/node_modules/vue/index.mjs';
import { defineHeadPlugin } from 'file:///home/Gerome-Elassaad/documentation/node_modules/@unhead/shared/dist/index.mjs';
import { createHooks } from 'file:///home/Gerome-Elassaad/documentation/node_modules/hookable/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///home/Gerome-Elassaad/documentation/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///home/Gerome-Elassaad/documentation/node_modules/unenv/runtime/fetch/index.mjs';
import { klona } from 'file:///home/Gerome-Elassaad/documentation/node_modules/klona/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/Gerome-Elassaad/documentation/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/Gerome-Elassaad/documentation/node_modules/radix3/dist/index.mjs';
import { getContext } from 'file:///home/Gerome-Elassaad/documentation/node_modules/unctx/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///home/Gerome-Elassaad/documentation/node_modules/errx/dist/index.js';
import devalue from 'file:///home/Gerome-Elassaad/documentation/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { getIcons } from 'file:///home/Gerome-Elassaad/documentation/node_modules/@iconify/utils/lib/index.mjs';
import { collections } from 'file:///home/Gerome-Elassaad/documentation/.nuxt/nuxt-icon-server-bundle.mjs';
import { fileURLToPath } from 'node:url';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///home/Gerome-Elassaad/documentation/node_modules/ipx/dist/index.mjs';
import lruCacheDriver from 'file:///home/Gerome-Elassaad/documentation/node_modules/unstorage/drivers/lru-cache.mjs';
import { initWasm, Resvg } from 'file:///home/Gerome-Elassaad/documentation/node_modules/@resvg/resvg-wasm/index.mjs';
import _satori, { init } from 'file:///home/Gerome-Elassaad/documentation/node_modules/satori/dist/index.wasm.js';
import initYoga from 'file:///home/Gerome-Elassaad/documentation/node_modules/yoga-wasm-web/dist/index.js';
import { readFile } from 'node:fs/promises';
import { resolvePath } from 'file:///home/Gerome-Elassaad/documentation/node_modules/mlly/dist/index.mjs';
...
const _eHhkyhna2M = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script$1}<\/script>`);
  });
});

const rootDir = "/home/Gerome-Elassaad/documentation";
...
const appConfig0 = defineAppConfig({
  ...
  header: {
    ...
    logo: {
      ...
      // Path to the logo for light mode
      dark: "/Repo-Booster-icon.png"
      // Path to the logo for dark mode
    },
    search: true,
  ...
  footer: {
    credits: "Copyright \xA9 2025 Repo-Booster",
    colorMode: true,
    // Enable color mode toggle in the footer
    links: [
      {
...
const _inlineRuntimeConfig = {
  ...
  "nuxt-site-config": {
    "stack": [
      ...
      },
      {
        ...
        "_priority": -10,
        "name": "documentation-repo-booster"
      }
    ],
    "version": "2.2.21",
    "debug": false
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "/home/Gerome-Elassaad/documentation/public"
      ]
    },
    "http": {
      "domains": []
...
const serverAssets = [{"baseName":"nuxt-og-image:fonts","dir":"/home/Gerome-Elassaad/documentation/.nuxt/cache/nuxt-og-image@3.1.1/_fonts"},{"baseName":"server","dir":"/home/Gerome-Elassaad/documentation/server/assets"}];
...
storage$1.mount('content:source:content', unstorage_47drivers_47fs({"name":"content:source:content","driver":"fs","base":"/home/Gerome-Elassaad/documentation/content","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('cache:content', unstorage_47drivers_47fs({"driver":"fs","base":"/home/Gerome-Elassaad/documentation/.nuxt/content-cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/Gerome-Elassaad/documentation","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/Gerome-Elassaad/documentation/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/Gerome-Elassaad/documentation/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/Gerome-Elassaad/documentation/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/Gerome-Elassaad/documentation/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _aaEmnuNGTw = defineNitroPlugin(async (nitro) => {
...
const _WyTECEg521 = defineNitroPlugin(async (nitroApp) => {
...
const componentNames = [{"hash":"Smy3kBtip1","pascalName":"OgImageDocs","kebabName":"og-image-docs","path":"/home/Gerome-Elassaad/documentation/app/components/OgImage/OgImageDocs.vue","category":"app"},{"hash":"i0Vxmj8bqg","pascalName":"BrandedLogo","kebabName":"branded-logo","path":"/home/Gerome-Elassaad/documentation/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/BrandedLogo.vue","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"},{"hash":"tBHg51xiAt","pascalName":"Frame","kebabName":"frame","path":"/home/Gerome-Elassaad/documentation/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Frame.vue","category":"community","credits":"@arashsheyda <https://github.com/arashsheyda>"},{"hash":"Sqc3OTP2KQ","pascalName":"Nuxt","kebabName":"nuxt","path":"/home/Gerome-Elassaad/documentation/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Nuxt.vue","category":"community","credits":"NuxtLabs <https://nuxtlabs.com/>"},{"hash":"ZZYBOVCtCQ","pascalName":"NuxtSeo","kebabName":"nuxt-seo","path":"/home/Gerome-Elassaad/documentation/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/NuxtSeo.vue","category":"community","credits":"Nuxt SEO <https://nuxtseo.com/>"},{"hash":"q432NYEB0T","pascalName":"Pergel","kebabName":"pergel","path":"/home/Gerome-Elassaad/documentation/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Pergel.vue","category":"community","credits":"Pergel <https://nuxtlabs.com/>"},{"hash":"6bQOH7FKu2","pascalName":"SimpleBlog","kebabName":"simple-blog","path":"/home/Gerome-Elassaad/documentation/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/SimpleBlog.vue","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"},{"hash":"wt558K6QyQ","pascalName":"UnJs","kebabName":"un-js","path":"/home/Gerome-Elassaad/documentation/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/UnJs.vue","category":"community","credits":"UnJS <https://unjs.io/>"},{"hash":"6RdQZcuwZZ","pascalName":"Wave","kebabName":"wave","path":"/home/Gerome-Elassaad/documentation/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Wave.vue","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"},{"hash":"gaB1TrbtTl","pascalName":"WithEmoji","kebabName":"with-emoji","path":"/home/Gerome-Elassaad/documentation/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/WithEmoji.vue","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"}];
...
const _CVXf6lEUDJ = defineNitroPlugin((nitroApp) => {
...
const _2L2JvzJVNV = defineNitroPlugin(async (nitro) => {
  return;
});
...
const _WEw5mPENwd = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const _6ObtB8 = eventHandler(async (event) => {
...
const _wGGV4g = defineCachedEventHandler(async (event) => {
...
const _gqFDA8 = defineEventHandler(async (e) => {
...
const _23YNyq = defineEventHandler(async (e) => {
...
const _BiKkzX = defineEventHandler(async (event) => {
...
const _daNaPI = defineEventHandler(async (event) => {
...
const _lKGq4o = defineEventHandler(async (event) => {
  const { getContentQuery } = await Promise.resolve().then(function () { return query; });
  const { cacheStorage, serverQueryContent } = await Promise.resolve().then(function () { return storage; });
...
const _oyBhCI = lazyEventHandler(() => {
...
const _lazy_tO2Ak4 = () => Promise.resolve().then(function () { return search_json_get$1; });
const _lazy_VXe8qH = () => Promise.resolve().then(function () { return renderer$1; });
const _lazy_VJCpgD = () => Promise.resolve().then(function () { return font$1; });
const _lazy_37uxFq = () => Promise.resolve().then(function () { return debug_json$1; });
const _lazy_rNFqYC = () => Promise.resolve().then(function () { return image$1; });

const handlers = [
  { route: '/api/search.json', handler: _lazy_tO2Ak4, lazy: true, middleware: false, method: "get" },
  { route: '/__nuxt_error', handler: _lazy_VXe8qH, lazy: true, middleware: false, method: undefined },
  { route: '/api/_mdc/highlight', handler: _6ObtB8, lazy: false, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _wGGV4g, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _gqFDA8, lazy: false, middleware: true, method: undefined },
  { route: '/__site-config__/debug.json', handler: _23YNyq, lazy: false, middleware: false, method: undefined },
  { route: '/__og-image__/font/**', handler: _lazy_VJCpgD, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/debug.json', handler: _lazy_37uxFq, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/image/**', handler: _lazy_rNFqYC, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/static/**', handler: _lazy_rNFqYC, lazy: true, middleware: false, method: undefined },
  { route: '/api/_content/query/:qid/**:params', handler: _BiKkzX, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query/:qid', handler: _BiKkzX, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query', handler: _BiKkzX, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/cache.json', handler: _daNaPI, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid/**:params', handler: _lKGq4o, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid', handler: _lKGq4o, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation', handler: _lKGq4o, lazy: false, middleware: false, method: "get" },
  { route: '/_ipx/**', handler: _oyBhCI, lazy: false, middleware: false, method: undefined },
  { route: '/_fonts/**', handler: _lazy_VXe8qH, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_VXe8qH, lazy: true, middleware: false, method: undefined }
];
  ...
  parse: async (_id, content) => {
    ...
    if (typeof content === "string") {
      if (_id.endsWith("json5")) {
        parsed = (await import('file:///home/Gerome-Elassaad/documentation/node_modules/json5/lib/index.js').then((m) => m.default || m)).parse(content);
...
async function useResvg() {
  resvgInstance.instance = resvgInstance.instance || await Promise.resolve().then(function () { return wasmFs$3; }).then((m) => m.default);
  await resvgInstance.instance.initWasmPromise;
  return resvgInstance.instance.Resvg;
}
async function useSatori() {
  satoriInstance.instance = satoriInstance.instance || await Promise.resolve().then(function () { return wasmFs$1; }).then((m) => m.default);
  await satoriInstance.instance.initWasmPromise;
  return satoriInstance.instance.satori;
}
async function useSharp() {
  sharpInstance.instance = sharpInstance.instance || await import('file:///home/Gerome-Elassaad/documentation/node_modules/unenv/runtime/mock/empty.mjs').then((m) => m.default);
  return sharpInstance.instance;
}
async function useCssInline() {
  cssInlineInstance.instance = cssInlineInstance.instance || await import('file:///home/Gerome-Elassaad/documentation/node_modules/unenv/runtime/mock/empty.mjs').then((m) => m.default);
...
function createShikiHighlighter({
  ...
  async function _getShiki() {
    const { createHighlighterCore, addClassToHast, isSpecialLang, isSpecialTheme } = await import('file:///home/Gerome-Elassaad/documentation/node_modules/shiki/dist/core.mjs');
    const { transformerNotationDiff, transformerNotationErrorLevel, transformerNotationFocus, transformerNotationHighlight } = await import('file:///home/Gerome-Elassaad/documentation/node_modules/@shikijs/transformers/dist/index.mjs');
...
const bundledLangs = {
"javascript": () => import('file:///home/Gerome-Elassaad/documentation/node_modules/shiki/dist/langs/javascript.mjs'),
"js": () => import('file:///home/Gerome-Elassaad/documentation/node_modules/shiki/dist/langs/javascript.mjs'),
"jsx": () => import('file:///home/Gerome-Elassaad/documentation/node_modules/shiki/dist/langs/jsx.mjs'),
"json": () => import('file:///home/Gerome-Elassaad/documentation/node_modules/shiki/dist/langs/json.mjs'),
"typescript": () => import('file:///home/Gerome-Elassaad/documentation/node_modules/shiki/dist/langs/typescript.mjs'),
"ts": () => import('file:///home/Gerome-Elassaad/documentation/node_modules/shiki/dist/langs/typescript.mjs'),
"tsx": () => import('file:///home/Gerome-Elassaad/documentation/node_modules/shiki/dist/langs/tsx.mjs'),
"vue": () => import('file:///home/Gerome-Elassaad/documentation/node_modules/shiki/dist/langs/vue.mjs'),
"css": () => import('file:///home/Gerome-Elassaad/documentation/node_modules/shiki/dist/langs/css.mjs'),
"html": () => import('file:///home/Gerome-Elassaad/documentation/node_modules/shiki/dist/langs/html.mjs'),
"shellscript": () => import('file:///home/Gerome-Elassaad/documentation/node_modules/shiki/dist/langs/shellscript.mjs'),
"bash": () => import('file:///home/Gerome-Elassaad/documentation/node_modules/shiki/dist/langs/shellscript.mjs'),
"sh": () => import('file:///home/Gerome-Elassaad/documentation/node_modules/shiki/dist/langs/shellscript.mjs'),
"shell": () => import('file:///home/Gerome-Elassaad/documentation/node_modules/shiki/dist/langs/shellscript.mjs'),
"zsh": () => import('file:///home/Gerome-Elassaad/documentation/node_modules/shiki/dist/langs/shellscript.mjs'),
"markdown": () => import('file:///home/Gerome-Elassaad/documentation/node_modules/shiki/dist/langs/markdown.mjs'),
"md": () => import('file:///home/Gerome-Elassaad/documentation/node_modules/shiki/dist/langs/markdown.mjs'),
"mdc": () => import('file:///home/Gerome-Elassaad/documentation/node_modules/shiki/dist/langs/mdc.mjs'),
"yaml": () => import('file:///home/Gerome-Elassaad/documentation/node_modules/shiki/dist/langs/yaml.mjs'),
"yml": () => import('file:///home/Gerome-Elassaad/documentation/node_modules/shiki/dist/langs/yaml.mjs'),
"diff": () => import('file:///home/Gerome-Elassaad/documentation/node_modules/shiki/dist/langs/diff.mjs'),
"ini": () => import('file:///home/Gerome-Elassaad/documentation/node_modules/shiki/dist/langs/ini.mjs'),
"properties": () => import('file:///home/Gerome-Elassaad/documentation/node_modules/shiki/dist/langs/ini.mjs'),
};
const bundledThemes = {
"material-theme-lighter": () => import('file:///home/Gerome-Elassaad/documentation/node_modules/shiki/dist/themes/material-theme-lighter.mjs').then(r => r.default),
"material-theme": () => import('file:///home/Gerome-Elassaad/documentation/node_modules/shiki/dist/themes/material-theme.mjs').then(r => r.default),
"material-theme-palenight": () => import('file:///home/Gerome-Elassaad/documentation/node_modules/shiki/dist/themes/material-theme-palenight.mjs').then(r => r.default),
};
const options = {"theme":{"light":"material-theme-lighter","default":"material-theme","dark":"material-theme-palenight"}};
const engine = createWasmOnigEngine(() => import('file:///home/Gerome-Elassaad/documentation/node_modules/shiki/dist/wasm.mjs'));
...
const getClientManifest = () => import('file:///home/Gerome-Elassaad/documentation/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///home/Gerome-Elassaad/documentation/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
...
const compatibility = {"chromium":"chrome-launcher","satori":"wasm-fs","resvg":"wasm-fs","sharp":false,"css-inline":false};
...
async function readWasmFile(input) {
...
const wasmFs$3 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: wasmFs$2
});
...
const wasmFs$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: wasmFs
});
